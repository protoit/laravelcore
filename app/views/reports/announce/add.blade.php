    ...
    <div class="span12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-reorder"></i>New Announce Report</div>
                <div class="tools">
                </div>
            </div>
                ...
                <form action="" class="horizontal-form" method="post" novalidate="novalidate" enctype="multipart/form-data">
                    ...
                    <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="shiftjournal_id" type="text" class="m-wrap" id="firstName" placeholder="" data-required="1">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="datetime" type="text" class="m-wrap" id="datetime" value="{{ date('d/m/Y H:i') }}" placeholder="yyyy-mm-dd">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="organization_id" type="text" class="m-wrap" id="organization_id">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="announce_name" type="text" class="m-wrap" id="announce_name">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="announce_birth" type="text" class="m-wrap" id="announce_birth">
                                </div>
                            </div>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="announce_ident" type="text" class="m-wrap" id="announce_ident">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="announce_address" type="text" class="m-wrap" id="announce_address">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="announce_zipcode" type="text" class="m-wrap" id="announce_zipcode">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="announce_city" type="text" class="m-wrap" id="announce_city">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="announce_phone" type="text" class="m-wrap" id="announce_phone">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <textarea name="announce_description" class="m-wrap" id="announce_description"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="parent_name" type="text" class="m-wrap" id="parent_name">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="parent_address" type="text" class="m-wrap" id="parent_address">
                                </div>
                            </div>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="parent_zipcode" type="text" class="m-wrap" id="parent_zipcode">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="parent_city" type="text" class="m-wrap" id="parent_city">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="parent_phone" type="text" class="m-wrap" id="parent_phone">
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="action_where" type="text" class="m-wrap" id="action_where">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <input name="action_datetime" type="text" class="m-wrap" id="action_datetime" value="{{ date('d/m/Y H:i') }}" placeholder="yyyy-mm-dd" />
                                </div>
                            </div>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="radio" name="type" value="Theft / Petty larceny" />
                                    Theft / Petty larceny
                                    </label>
                                    <label class="radio line">
                                    <input type="radio" name="type" value="Damage" />
                                    Damage
                                    </label>  
                                    <label class="radio line">
                                    ...
                                    <input name="type_other" type="text" class="m-wrap" id="type_other">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <textarea name="announce_item" class="m-wrap" id="announce_item"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <input name="announce_item_value" type="text" class="m-wrap" id="announce_item_value"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <input name="announce_item_sum" type="text" class="m-wrap" id="announce_item_sum"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                    <label class="radio line">
                                    <input type="radio" name="announce_item_status" value="The goods are paid" />
                                    The goods are paid
                                    </label>
                                    <label class="radio line">
                                    <input type="radio" name="announce_item_status" value="Returned" />
                                    Returned
                                    </label>  
                                    <label class="radio line">
                                    <input type="radio" name="announce_item_status" value="Corrupted" />
                                    Corrupted
                                    </label>  
                                <label class="radio line">
                                    <input type="radio" name="announce_item_status" value="Other" />
                                    Other
                                  </label>  
