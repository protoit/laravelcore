    ...
    <div class="span12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-reorder"></i>Update Service Report</div>
                <div class="tools">
                    ...
                    <div class="row-fluid">
                        <div class="span6 ">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="shiftjournal_id" type="text" class="m-wrap span12" id="firstName" value="{{ $row->shiftjournal_id }}" placeholder="" data-required="1">
                        ...
                        <div class="span6 ">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="date" type="text" class="m-wrap span12" id="date" value="{{ $row->date }}" placeholder="yyyy-mm-dd">
                    ...
                    <div class="row-fluid">
                        <div class="span6 ">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="time_start" type="text" class="m-wrap span12 timepicker-241" id="firstName" value="{{ $row->time_start }}" placeholder="">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="span6 ">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="time_end" type="text" class="m-wrap span12 timepicker-241" id="lastName" value="{{ $row->time_end }}" placeholder="">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row-fluid">
                        <div class="span6 ">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="title" type="text"  class="m-wrap span12" id="title" value="{{ $row->title }}"> 
                                </div>
                            </div>
                        </div>
                        <!--/span-->
                        <div class="span6 ">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  <textarea name="description" class="m-wrap span12" id="description">{{ $row->description }}</textarea> 
                                </div>
                            </div>
                        </div>
                        <!--/span-->
