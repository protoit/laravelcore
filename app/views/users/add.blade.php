                ...
                <div class="span6">
                  <div class="control-group">
                    ...
                    <label class="control-label" for="admin">
                       ...
                       type="checkbox" 
                       value="1"
                       <?php if(Input::get('admin') == '1') echo 'checked';?>> Admin             
                    </label>
                    </div>   
                  </div>
                </div>
                ...
                <div class="span6">
                  <div class="control-group">
                    ...
                    <label class="control-label" for="status">
                       ...
                       type="checkbox" 
                       value="active" 
                       <?php if(Input::get('status') == 'active') echo 'checked';?>> Active             
                    </label>
                    </div>   
                  </div>
                </div>
