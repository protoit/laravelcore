...
<head>
	...
	<link href="{{ Request::root()}}/assets/css/pages/login.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<!--<img src="{{ Request::root()}}/assets/img/logo-big.png" alt="" /> -->
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
	...
	<script src="{{ Request::root()}}/assets/plugins/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="{{ Request::root()}}/assets/scripts/app.js" type="text/javascript"></script>
	<script src="{{ Request::root()}}/assets/scripts/login.js" type="text/javascript"></script>      
