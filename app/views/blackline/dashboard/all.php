  ...
  <script src="<?=base_url()?>assets/blackline/js/moment.js"></script>
  <script src="<?=base_url()?>assets/blackline/js/moment.min.js"></script>
  <script>
 ...
 <div id="main"> 
        ...
        $tel=$_POST['txttel'];  
        $fax=$_POST['txtfax'];                       
        mysql_query("insert into timesheets(date, day, start, end, object, qty, tjenestenr) values('$lname','$company','$address','$pcode','$email','$tel','$fax')") or die ();  
        mysql_set_charset('utf8');
        $flag=1;  
        ...
        <th><label style="width: 1%;">Dag</label></th>
        ...
        <td style="width:100px;"><input class="required datepicker" id="datepicker" style="width: 140px;" type="text" name="txtlname" value="9 Oct 2012" readonly="readonly" /></td>
        <td style="width:20%;"><select class="required inpt" style="width: 100%;" name="txtcompany">
        ...
        <input class="required inpt" style="width:20%;" type="hidden" name="txttel" value="" />
