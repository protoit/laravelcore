	 ...
	 <div class="span4">
		...
		<div class="subcont">
			<ul class="details">
				...
				<li><span><?=$this->lang->line('application_uploaded_by');?>:</span> <a class="label label-info"><?php if(isset($media->user->id)){?> <?=$media->user->firstname;?> <?=$media->user->lastname;?> <?php } else{ ?> <?=$media->client->firstname;?> <?=$media->client->lastname;?> <?php } ?></a></li>
				...
				<li><span><?=$this->lang->line('application_download');?>:</span> <a href="<?=base_url()?>cprojects/download/<?=$media->id;?>" class="btn btn-small btn-success"><i class="icon-download icon-white"></i> <?=$this->lang->line('application_download');?></a></li>
	 ...
	 <div class="span8">
			...
			break;
			  ...
			  <div class="message-content">
			         ...
			         <a href="<?=base_url()?>cprojects/deletemessage/<?=$media->project_id;?>/<?=$media->id;?>/<?=$value->id;?>" rel="" class="btn btn-mini pull-right btn-danger"><i class="icon-trash icon-white"></i></a>
			 		<?php } ?>
			 		</div>
