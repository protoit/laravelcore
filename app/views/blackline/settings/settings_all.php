...
<table id="settings" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td><?=$this->lang->line('application_logo_stamp');?> <?=$this->lang->line('application_logo');?> <a class="cursor po pull-right" rel="popover" data-content="<div class='logo' style='background:#FFFFFF'><img src='<?=$core_settings->invoice_logo;?>'></div>" data-original-title="<?=$this->lang->line('application_logo_stamp');?> <?=$this->lang->line('application_logo');?>"><i class="fam-information"></i></a>
        </td>
        <td>
            <input type="file" name="userfile2" id="file2">
            <div class="dummyfile">
