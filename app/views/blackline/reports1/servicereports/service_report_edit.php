...
<div class="row">
        <h5><strong><span>Tjenesterapport Informasjon</span></strong></h5>
         ...
         <span>Journal ID:</span>
            ...
            <input class=" " name="service-shiftjournalid" type="text" maxlength="100" value="<?php echo $service[0]->shiftjournal_id;?>" >
         <br/>
            <span>Dato:</span>
            <!--Write data to service_reports->date. Get today's date.-->    
            <input class="required datepicker" name="service-date" type="text" maxlength="100" value="<?php echo $service[0]->datetime;?>">
         <br/>
            <span>Fra Tid:</span>
            <!--Write data to service_reports->start.-->    
            <input class=" " name="service-datetime-start" type="text" maxlength="100" value="<?php echo $service[0]->start;?>">
         <br/>
            <span>Til Tid:</span>
            <!--Write data to service_reports->end -->    
            <input class=" " name="service-datetime-end" type="text" maxlength="100" value="<?php echo $service[0]->end;?>">
         <br/>
         ...
         <span>Antall Vedlegg:</span>
            ...
            <input class="required" name="service-tjenestenr-qty" type="text" maxlength="100" value="<?php echo $service[0]->attachment_qty;?>"/>
         <br/>
