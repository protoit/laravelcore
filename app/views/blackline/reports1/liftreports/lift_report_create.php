...
<div class="row">
        ...
        <h5><strong><span>Informasjon</span></strong></h5>
         ...
         <span>Personer i heisen:</span>
            ...
            <div class="radiobutton"><input type="radio" id="person-lift-yes" name="person-lift" value="Yes"><label for="person-lift-yes">Yes</label></div>
            <div class="radiobutton"><input type="radio" id="person-lift-no" name="person-lift" value="No"><label for="person-lift-no">No</label></div>
         ...
         <span>Tilbakemelding gitt til innringer:</span>
            ...
            <div class="radiobutton"><input type="radio" id="contact-feedback-yes" name="contact-feedback" value="Yes"><label for="contact-feedback-yes">Yes</label></div>
            <div class="radiobutton"><input type="radio" id="contact-feedback-no" name="contact-feedback" value="No"><label for="contact-feedback-no">No</label></div>
