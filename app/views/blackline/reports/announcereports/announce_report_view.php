...
<div id="options">
            <?php if($this->user){ ?>
			<?php if(($id->tjenestenr==$announce_reports[0]->tjenestenr) ||($id->admin)){ ?>
...
<hr>
        <div class="row">
            ...
            <div class="span6">
                <div class="table_head"><h6>Rapport Informasjon</h6></div>
                    <div class="subcont">
                        <ul class="details">
                            <li><span>Dato &amp; Tid: </span><?php echo date("d/m/Y H:i", strtotime($announce_reports[0]->datetime));?></li>
                            <li></li>
        ...
        <?php if(@$this->client) { ?>
            <div class="row">
            <div class="table_head"><h6>Informasjon om anmeldte</h6></div>
            <div class="subcont">
            <ul class="details">
            <li><span>Sensitivt informasjon!</span></li>
        </ul>
            </div>
        </div>
        <?php } else { ?> 
        ...
        <ul class="details">
            <li><span>Anmeldtes navn: </span></br><?php echo $announce_reports[0]->announce_name;?></li>
            <li><span>Anmeldtes adresse: </span></br><?php echo $announce_reports[0]->announce_address;?></li>
            <li><span>Anmeldtes postnr: </span></br><?php echo $announce_reports[0]->announce_zipcode;?></li>
            <li><span>Anmeldtes by: </span></br><?php echo $announce_reports[0]->announce_city;?></li>
            <li><span>Anmeldtes telefon: </span></br><?php echo $announce_reports[0]->announce_phone;?></li>
            <li><span>Legitimasjon (Type/Nummer): </span></br><?php echo $announce_reports[0]->announce_ident;?></li>
            <li><span>Fødselsnummer: </span></br><?php echo $announce_reports[0]->announce_birth;?></li>
            <li><span>Beskrivelse av anmeldte: </span></br><?php echo $announce_reports[0]->announce_description;?></li>
        </ul>
            </div>
            </div>

            <div class="span4">
        <div class="table_head"><h6>Informasjon om VERGE</h6></div>
        <div class="subcont">
        <ul class="details">
            <li><span>Verges navn:</span></br><?php echo $announce_reports[0]->parent_name;?></li>
            <li><span>Verges adresse:</span></br><?php echo $announce_reports[0]->parent_address;?></li>
            <li><span>Verges postnr:</span></br><?php echo $announce_reports[0]->parent_zipcode;?></li>
            <li><span>Verges by:</span></br><?php echo $announce_reports[0]->parent_city;?></li>
            <li><span>Verges telefon:</span></br><?php echo $announce_reports[0]->parent_phone;?></li>
        </ul>
            </div>
            </div>

            <div class="span4">
        <div class="table_head"><h6>Informasjon om VITNE</h6></div>
        <div class="subcont">
        <ul class="details">
            <li><span>Vitnes navn:</span></br><?php echo $announce_reports[0]->witness_name;?></li>
            <li><span>Vitnes adresse:</span></br><?php echo $announce_reports[0]->witness_address;?></li>
            <li><span>Vitnes postnr:</span></br><?php echo $announce_reports[0]->witness_zipcode;?></li>
            <li><span>Vitnes by:</span></br><?php echo $announce_reports[0]->witness_city;?></li>
            <li><span>Vitnes telefon:</span></br><?php echo $announce_reports[0]->witness_phone;?></li>
        </ul>
            </div>
            </div>
            </div>
        ...
        <ul class="details">
            ...
            <li><span>Når fant forholdet sted (Dato &amp; Tid):</span><?php echo date("d/m/Y H:i", strtotime($announce_reports[0]->action_datetime));?></li>
