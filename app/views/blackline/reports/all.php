...
<div class="visible-phone"><br/></div>
	...
	<?php if($this->user || $id->company_id==35){ ?>
    <div class="table_head"><h6><i class="icon-list-alt"></i><? echo $this->lang->line('application_liftreport');?> - Sameiet Grønlandstunet</h6></div>
    <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='data3' id='reports2' rel="#">
    	<thead>
        <tr>
            <th width='1%'>ID</th>
            <th width='1%'><? echo $this->lang->line('application_date');?></th>
			...
			foreach($lift_reports as $report){ ?>
				<tr>
					...
					<?php } ?>
						...
						<div class="arrow"></div><view href="<?php echo base_url();?>reports/view_report/lift/<?php echo $report->id;?>"></view>
					</td>
