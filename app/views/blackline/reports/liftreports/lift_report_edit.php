...
<div class="row">
        ...
        <h5><strong><span>Rapport Informasjon</span></strong></h5>
         ...
         <br/>
            ...
            <input class="datepicker" name="date" type="text" maxlength="100" value="<?php echo date("d/m/Y", strtotime($liftreport[0]->datetime)) ;?>">
         <br/>
         ...
         <span>Personer i heisen:</span>
            ...
            <div class="radiobutton"><input <?php if($liftreport[0]->person_lift=="Yes") echo 'checked="checked"';?> type="radio" id="person-lift-yes" name="person-lift" value="Yes"><label for="person-lift-yes">Ja</label></div>
            <div class="radiobutton"><input type="radio" <?php if($liftreport[0]->person_lift=="No") echo 'checked="checked"';?>  id="person-lift-no" name="person-lift" value="No"><label for="person-lift-no">Nei</label></div>
         ...
         <span>Tilbakemelding gitt til innringer:</span>
            ...
            <div class="radiobutton"><input type="radio" <?php if($liftreport[0]->contact_feedback=="Yes") echo 'checked="checked"';?> id="contact-feedback-yes" name="contact-feedback" value="Yes"><label for="contact-feedback-yes">Ja</label></div>
            <div class="radiobutton"><input type="radio" <?php if($liftreport[0]->contact_feedback=="No") echo 'checked="checked"';?> id="contact-feedback-no" name="contact-feedback" value="No"><label for="contact-feedback-no">Nei</label></div>
