    ...
    <form method="post" action="<?php echo base_url();?>reports/edit_report/announce/<?php echo $this->uri->segment(4);?>">
        <h5><strong><span>Anmeldelse Informasjon</span></strong></h5>
         ...
         <br/>
            ...
            <input class="datepicker" name="announce-datetime" type="text"  value="<?php echo date("d/m/Y H:i", strtotime($announce_reports[0]->datetime));?>">
         <br/>
         <?php
        if(@$this->user->admin){?>
...
<div class="row">
        ...
        <h5><strong><span>Informasjon om verge:</span></strong></h5>
         ...
         <span>Når fant forholdet sted:</span>
            ...
            -->        
            <input class="required datepicker" name="announce-action-datetime" type="text"  value="<?php echo date('d/m/Y H:i', strtotime($announce_reports[0]->action_datetime));?>">
         <br/>
         <span>Forhold:</span>
