...
<div class="visible-phone"><br/></div>
    ...
    <div class="table_head"><h6><i class="icon-list-alt"></i><? echo $this->lang->line('application_actreport');?>er</h6></div>
    	<table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='data' id='reports' rel="<?=base_url()?>">
        <thead>
        <tr>
            <th width='1%'>ID</th>
        ...
        <?php
			...
			if($report->status=='deleted')
				...
				<tr id="<?=$report->id;?>">
                    ...
                    <a href="<?php echo base_url();?>reports/view_report/service/<?php echo $report->id;?>" class="btn btn-mini" data-toggle=""><i class="icon-zoom-in"></i></a>
                    <a href="<?php echo base_url();?>preview/service/<?php echo $report->id;?>" class="btn btn-mini" data-toggle=""><i class="icon-print"></i></a>
    ...
    <div class="table_head"><h6><i class="icon-list-alt"></i><? echo $this->lang->line('application_announce');?></h6></div>
        ...
        <?php
			...
			foreach($announce_reports as $report){ ?>
				<tr>
                    ...
                    <a href="<?php echo base_url();?>reports/view_report/announce/<?php echo $report->id;?>" class="btn btn-mini" data-toggle=""><i class="icon-zoom-in"></i></a>
                    <a href="<?php echo base_url();?>preview/announce/<?php echo $report->id;?>" class="btn btn-mini" data-toggle=""><i class="icon-print"></i></a>
    ...
    <div class="table_head"><h6><i class="icon-list-alt"></i><? echo $this->lang->line('application_liftreport');?> - Sameiet Grønlandstunet</h6></div>
    <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='data2' id='' rel="#">
    	<thead>
        <tr>
            <th width='1%'>ID</th>
            <th width='1%'><? echo $this->lang->line('application_date');?></th>
            <th width='1%'>Varslingtidspunkt</th>
            <th width='1%'>Objekt</th>
            <th width='1%'>Bevokningsadresse</th>
			<th width="1%"><? echo $this->lang->line('application_employeeID');?></th>
            <th width="1%">Journal ID</th>
            <th width='2%' style="text-align: center;"><? echo $this->lang->line('application_action');?></th>
        </tr>
        ...
        <?php
			...
			foreach($lift_reports as $report){ ?>
				<tr>
                    <td><?php echo $report->id;?></td>
                    <td><?php echo date('d/m/Y',strtotime($report->datetime));?></td>
                    <td><?php echo date('H:i',strtotime($report->warning_time));?></td>
                    ...
                    <a href="<?php echo base_url();?>reports/edit_report/lift/<?php echo $report->id;?>" class="btn btn-mini"><i class="icon-edit"></i></a>
                    <a href="<?php echo base_url();?>reports/view_report/lift/<?php echo $report->id;?>" class="btn btn-mini"><i class="icon-zoom-in"></i></a>
