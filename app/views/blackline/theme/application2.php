...
<html>
  <head> 
	...
	<script type="text/javascript" src="<?=base_url()?>assets/blackline/js/moment.js"></script>
    <link rel="SHORTCUT ICON" href="<?=base_url()?>assets/blackline/img/favicon2.ico"/>
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/blackline/css/daterangepicker.css" />
...
.dummyfile{ display: none !important;}';
  ...
  <body>
    ...
    <?php } ?>
	  ...
	  <script type="text/javascript" src="<?=base_url()?>assets/blackline/js/daterangepicker.js"></script>
      ...
      $(document).ready(function(){
       ...
       var oTable = $('table.data').dataTable({
		...
		//$("#company_select").html(fnCreateSelect( oTable.fnGetColumnData(2) ));
       ...
       var sTable = $('table.data-small').dataTable({
        ...
        $("#daterange").keyup ( function() { oTable2.fnDraw(); } );
        $("#daterange").change( function() { oTable2.fnDraw(); } );
        $("#daterange").mousemove( function() { oTable2.fnDraw(); } );
        $("#daterange").blur( function() { oTable2.fnDraw(); } );
